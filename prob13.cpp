...
void sum_digit(int* matrix)
{
	long int sum[COLUMN] = {0};
...
int prob13()
{										 
	int mat[ROW * COLUMN] =	{ 3,7,1,0,7,2,8,7,5,3,3,9,0,2,1,0,2,7,9,8,7,9,7,9,9,8,2,2,0,8,3,7,5,9,0,2,4,6,5,1,0,1,3,5,7,4,0,2,5,0,
	...
	int test_mat[ROW * COLUMN] = { 1 ,2 ,3 ,4 , 5 ,6,7,8,9  };
	sum_digit((int *)mat);
	// ans : 5537376230
	return 0;
}